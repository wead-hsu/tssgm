...
def main(_):
   ...
   # val_it = BatchIterator(len(val), FLAGS.batch_size, [val], testing=False)
    ...
    with tf.Session(config=configproto) as sess:
        ...
        return model.run(sess, train_it, unlabel_it, test_it, FLAGS.n_iter, FLAGS.keep_rate, save_dir, FLAGS.batch_size, FLAGS.alpha, vars(FLAGS)['__flags'])
